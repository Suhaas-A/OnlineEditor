...
function CreateListFiles() {
    ...
    async function list() {
        const response = await axios.get('http://127.0.0.1:8000/api/list_create_files/', {
            headers: {
    ...
    async function editFile() {
        axios.patch('http://127.0.0.1:8000/api/view_update_delete_files/' + String(currentFileId), {'name': newName}, {
            headers: {
                Authorization: `Bearer ${sessionStorage.accessToken}`
            }
        }).then((response) => {
    ...
    function create() {
        axios.post('http://127.0.0.1:8000/api/list_create_files/', {'name': String(fileName), 'created_by': String(sessionStorage.username)}, {
            headers: {
                Authorization: `Bearer ${sessionStorage.accessToken}`
            }
        }).then((response)=> {
