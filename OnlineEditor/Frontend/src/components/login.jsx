...
function Login() {
    ...
    async function ForgetPassword() {
        if (! newPassword === newPasswordAgain) {
            ...
            axios.post('https://OnlineEditorMaster.pythonanywhere.com/api/forget_password/', {
    ...
    async function ResetPassword() {
        ...
        if (otp != readOtp) {
            axios.patch('https://OnlineEditorMaster.pythonanywhere.com/api/reset_password/' + resetUsername, {
    ...
    async function submit() {
        if (username == '' || password == '') {
            ...
            let response = await axios.post('https://OnlineEditorMaster.pythonanywhere.com/api/login/', {
                'username': username,
                'password': password,
            }).then((response) => {
